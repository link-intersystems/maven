...
public class PropertyEditorField {
	...
	public PropertyEditorField(Object mojo, Field propertyEditorField) {
		...
		propertyEditor = propertyEditorField
				.getAnnotation(PropertyEditor.class);
	}
	...
	public void setValue(PropertyEditorComponent<?> propertyEditorComponent,
			String propValue) {
		...
		try {
			...
			throw new IllegalStateException("Unable to set field " + getType()
					+ "." + propertyEditorField.getName(), e);
		}
	...
	public String toString() {
		...
		toStringBuilder.append(Modifier.toString(propertyEditorField
				.getModifiers()));
		toStringBuilder.append(" ");
